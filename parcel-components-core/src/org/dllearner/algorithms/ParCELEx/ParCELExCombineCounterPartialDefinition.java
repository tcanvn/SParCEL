...
public class ParCELExCombineCounterPartialDefinition {
	...
	public static Set<ParCELExtraNode> getCombinable(ParCELNode description,
		...
		HashSet<Individual> coveredNegativeExamples = new HashSet<Individual>();
	 ...
	 */
	private static int countIntersection(Set<Individual> set1, Set<Individual> set2) {
		int count = 0;

		for (Individual ind : set2) {
