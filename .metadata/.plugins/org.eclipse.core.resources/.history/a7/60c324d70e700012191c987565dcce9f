...
public class ParCELExFortifiedCrossValidationOrtho2 extends CrossValidation {
	...
	*/
	...
	public ParCELExFortifiedCrossValidationOrtho2(AbstractCELA la, PosNegLP lp, AbstractReasonerComponent rs,
	 ...
	 */
	public ParCELExFortifiedCrossValidationOrtho2(AbstractCELA la, ParCELPosNegLP lp, AbstractReasonerComponent rs,
			int folds, boolean leaveOneOut, int noOfRuns) {
