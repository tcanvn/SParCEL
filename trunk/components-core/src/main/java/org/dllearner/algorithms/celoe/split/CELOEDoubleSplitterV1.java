package org.dllearner.algorithms.celoe.split;
...
public class CELOEDoubleSplitterV1 implements CELOEDoubleSplitterAbstract {
	 ...
	 */
	public CELOEDoubleSplitterV1(AbstractReasonerComponent reasoner,
