...
public class RhoDRDown2008Int extends RefinementOperatorAdapter {

	private static Logger logger = Logger.getLogger(RhoDRDown2008Int.class);	
	...
	public RhoDRDown2008Int(AbstractReasonerComponent reasoningService) {
		this.rs = reasoningService;
		this.subHierarchy = rs.getClassHierarchy();
	}

	public RhoDRDown2008Int(AbstractReasonerComponent reasoner, ClassHierarchy subHierarchy, Description startClass) {
		this.rs = reasoner;
