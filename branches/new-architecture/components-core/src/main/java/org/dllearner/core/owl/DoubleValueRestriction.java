 ...
 *
 */
public class DoubleValueRestriction extends DatatypeValueRestriction {

	private Double doubleValue;
	
	public DoubleValueRestriction(DatatypeProperty restrictedPropertyExpression, Double value) {
		// TODO: we pass it as typed property, although it could be untyped
		super(restrictedPropertyExpression, new TypedConstant(value.toString(), OWL2Datatype.DOUBLE.getDatatype()));
		doubleValue = value;
	}
