		...
		for (int kk = 0; kk < noOfRuns; kk++) {
			...
			for (int currFold = 0; currFold < folds; currFold++) {
				...
				for (CELOE.PartialDefinition cpdef : counterPartialDefinitions) {
					...
					//--------------------
					//orthogonality check, this is unused currently
					//--------------------
					...
					outputWriter(c++ + changed + ". " + getCpdefString(cpdef, baseURI, prefixes)
				...
				*/
				...
				for (int i=0; i< strategyNames.length; i++) {					
					outputWriter("  multi-step fortified accuracy by " + strategyNames[i] + "(cpdef:" + arrayToString(noOfCpdefMultiStep) + "):");
			...
			for (int i=0; i< strategyNames.length; i++) {
				...
				outputWriter("  multi-step fortified accuracy by " + strategyNames[i] + "(cpdef:" + noOfCpdefUsedMultiStepFortStat[i] + "):");
